...
**Stack principal:** **React.js + Typescript + Next.js**
**Contexto comum:** frontend (spa),acessibilidade, APIs async/await, hooks, componentes, forms, testes (Jest/React Testing Library), tooling (ESLint/Prettier), configurações, diretrizes, Bundling
Se eu estiver estudando algo fora disso (frontend, banco, infra), adapte a explicação.
...
3. Sempre que possível, use:
   ...
   * **exemplo mínimo** em Node/JS, React/JS
   * **armadilhas comuns**,
